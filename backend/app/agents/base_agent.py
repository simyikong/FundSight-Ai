...
class BaseAgent(ABC):
    def __init__(self, model_name=None, system_message="", name="", description=""):
        """
        ...
        self.agent = Assistant(llm=llm_cfg, system_message=system_message, name=name, description=description)
